...
const PATHS: Record<Name, string> = {
  ...
  eye: '<path d="M2.06 12.32a1 1 0 0 1 0-.64C3.6 7.69 7.5 4.5 12 4.5s8.4 3.19 9.94 7.18a1 1 0 0 1 0 .64C20.4 16.31 16.5 19.5 12 19.5s-8.4-3.19-9.94-7.18"/><circle cx="12" cy="12" r="3"/>',
  unlock:
  ...
  moon: '<path d="M21 14.5A8.5 8.5 0 1 1 11.5 3 7 7 0 0 0 21 14.5z"/>',
